...
public class Bending_Stress extends AppCompatActivity {

    TextView DiameterCALCResult, CalcPowerTrans, CalcLineVolecity;
    EditText Np, Pd, Sigma, Ko, Qv, Kv, face, Km, Kb, J, Sp;
    Button Calc_BTN;
    Double Nteeth;
    Double Pichd;
    Double SIGMA;
...
//                KV = Double.valueOf(((Akm + linevolecity) / (Akm)) * Bkm);
                ...
                String Snum6 = J.getText().toString();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void init() {
        ...
        J = (EditText) findViewById(R.id.ET10);
